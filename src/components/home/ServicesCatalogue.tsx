      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-gray-600">
            Discover luxurious beauty treatments designed to enhance your
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <button className="mt-8 rounded-full bg-yellow-600 px-6 py-3 font-semibold text-white transition hover:bg-yellow-700">
                  View Services
                </button>
              </div>
            </div>
